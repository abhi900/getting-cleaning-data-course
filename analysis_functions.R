...
# and measures.
# set.type must be "training" or "test"
########################################################################################
create.set <- function(set.type) {
        ...
        if (!set.type %in% c("train","test")) {
                stop("Invalid set.type, It must be training or test dataset")
        }
...
########################################################################################
# This function imports descriptive activity names to name the activities in the data set 
# and returns the column names for the total dataset.
########################################################################################
...
########################################################################################
# This function extracts only the measurements on the mean
